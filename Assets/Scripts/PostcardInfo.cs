...
public class PostcardInfo : MonoBehaviour {

	public static string postcardInfoPath = "";
	public long nextUpdate;

	// Use this for initialization
	void Start () {
		postcardInfoPath = (Application.persistentDataPath + Controller.slot + "/postcardinfo");
	...
	public static void AddPostcard(string placeID){
		if(!HasPostcard(placeID)){
			StreamWriter file = new StreamWriter (postcardInfoPath,true);
			file.WriteLine (Security.Rot39("pet:"+placeID+";fullness:86400;happiness:86400;fitness:86400;tickmet:"+System.DateTime.Now.Ticks+";costume1:false;costume2:false;costume3:false;costume4:false",395445));
			file.Close ();
	...
	public static void UnlockCostume(string petID,int costume){
		...
		StreamReader theReader = new StreamReader(postcardInfoPath, Encoding.Default);
		using (theReader) {
		...
		theReader.Close ();
		StreamWriter theWriter = new StreamWriter(postcardInfoPath);
	...
	public static bool HasPostcard(string cityId){
		string line = null;
		bool rightPet = false;
		StreamReader theReader = new StreamReader(postcardInfoPath, Encoding.Default);
		using (theReader) {
	...
	public static void StartUpdatePetInfo(long lastVisit){
		postcardInfoPath = (Application.persistentDataPath + Controller.slot + "/petinfo");
		string line = null;
		bool pet = false;
		int oldFullness = 0;
		int oldHappiness = 0;
